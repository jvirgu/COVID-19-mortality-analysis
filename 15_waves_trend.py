...
ondas = [
    {"label": "1st Wave", "inicio": "2020-01-01", "fim": "2020-09-30", "cor": "#7b5ea7"},
    {"label": "2nd Wave", "inicio": "2020-10-01", "fim": "2021-05-31", "cor": "#c0823a"},
    {"label": "3rd Wave", "inicio": "2021-07-01", "fim": "2021-11-30", "cor": "#b03060"},
    {"label": "4th Wave", "inicio": "2021-12-01", "fim": "2022-12-30", "cor": "#5b8db8"},
]
...
ax.set_xlabel("Period", fontsize=15, fontweight="bold")
ax.set_ylabel("Number of Patients", fontsize=15, fontweight="bold")
ax.set_title("Temporal Trends in Hospitalizations and Deaths Across COVID-19 Waves\n(Jan/2020 – Dez/2022)",
             fontsize=22, fontweight="bold", pad=25)

# Legenda dentro do gráfico
legend_elementos = [
    Line2D([0], [0], color="#2980b9", lw=3, label="Hospitalizations (total)"),
    Line2D([0], [0], color="#27ae60", lw=3, label="Discharge"),
    Line2D([0], [0], color="#e74c3c", lw=3, label="Death"),
    Line2D([0], [0], color="black", lw=1.8, linestyle="--", label="Start of Vaccination"),
    plt.Rectangle((0, 0), 1, 1, fc="#7b5ea7", alpha=0.5, label="1st Wave"),
    plt.Rectangle((0, 0), 1, 1, fc="#c0823a", alpha=0.5, label="2nd Wave"),
    plt.Rectangle((0, 0), 1, 1, fc="#b03060", alpha=0.5, label="3rd Wave"),
    plt.Rectangle((0, 0), 1, 1, fc="#5b8db8", alpha=0.5, label="4th Wave"),
]
...
stats_ondas = [
    {"x": "2020-05-01", "label": "1st Wave\n(ref.)"},
    {"x": "2020-11-15", "label": "2nd Wave\nOR=0.67 [0.45–0.98]\np=0.041"},
    {"x": "2021-09-01", "label": "3rd Wave\nOR=0.64 [0.40–1.03]\np=0.068"},
    {"x": "2022-04-01", "label": "4th Wave\nOR=0.14 [0.09–0.23]\np<0.001"},
]
...
# ── 7. SALVAR ────────────────────────────────────────────────────────────
plt.savefig("grafico_tendencia_covid.png", dpi=300, bbox_inches="tight")
plt.savefig("grafico_tendencia_covid.pdf", bbox_inches="tight")
plt.show()
print("Gráfico salvo como PNG e PDF com sucesso.")
