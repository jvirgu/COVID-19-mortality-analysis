...
def simulate_nbinom(n, median, p25, p75, max_val, rng):
    ...
    p = r / (r + mean_)
    samples = nbinom.rvs(r, p, size=n * 3,
...
############ RETIREI O TITULO E SUBTITULO ####################################
# ax.set_title("Distribution of Hospital Length of Stay According to Outcome",
#              fontsize=25, fontweight="bold", color=TEXT, pad=30)
# ax.text(0.5, 1.01,
#         "Discharge vs. Death | n = 703",
#         transform=ax.transAxes,
#         fontsize=15, color=SUBTEXT, ha="center", va="bottom")
