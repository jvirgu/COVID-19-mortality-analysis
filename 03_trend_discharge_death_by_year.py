...
ax.plot(alta.index, alta.values, color=TEAL, linewidth=2.5,
        ...
        markeredgecolor=TEAL, markeredgewidth=2, label='Discharge (0)')
ax.plot(obito.index, obito.values, color=ORANGE, linewidth=2.5,
        marker='o', markersize=10, markerfacecolor=SURF,
        markeredgecolor=ORANGE, markeredgewidth=2, label='Death (1)')
...
# Y-axis tick labels — tick_params does not accept fontfamily, use a loop
