...
# Linha vertical tracejada ligando as duas medianas (no eixo x de cada)
# — seta dupla no eixo x, entre x=26 e x=65, posicionada entre os dois grupos
...
# Remove os ytick labels padrão e desenha manualmente dois textos por grupo
ax.set_yticks(ys)
ax.set_yticklabels([""] * len(labels))  # apaga labels padrão

# Largura do texto no eixo — usa transform para posicionar à esquerda do plot
