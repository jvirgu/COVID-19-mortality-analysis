...
# Este script foi originalmente escrito para rodar em células de notebook
# (Jupyter/IPython). Para executar como script .py, instale as dependências
# via terminal antes de rodar:
...
# %% RL com todas as variáveis independentes
modelo_rl = smf.glm(
